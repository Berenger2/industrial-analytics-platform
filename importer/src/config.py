...
class Config:
    ...
    def from_env(cls) -> "Config":
        ...
        return cls(
            ...
            csv_pattern=optional_env("IMPORT_CSV_PATTERN", "*.csv"),
            csv_delimiter=csv_delimiter,
            xml_pattern=optional_env("IMPORT_XML_PATTERN", "*.xml"),
            xml_record_tag=optional_env("IMPORT_XML_RECORD_TAG", "record"),
            log_level=log_level,
